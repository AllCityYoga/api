...
describe('express rest api server', function(){
  ...
  it('posts a challenge', function(done){
  ...
  it('retrieves a challenge', function(done){
  ...
  it('retrieves challenges', function(done){
  ...
  it('retrieves challenges by tags', function(done){
    superagent.get('http://localhost:3000/users')
      .end(function(e, res){
        // console.log(res.body)
        expect(e).to.eql(null)
  ...
  it('tags a challenge', function(done){
  ...
  it('checks a tagged challenge', function(done){
    superagent.get('http://localhost:3000/users/'+id)
      .end(function(e, res){
        // console.log(res.body)
        var result = res.body;
